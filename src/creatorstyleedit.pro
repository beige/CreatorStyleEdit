...
isEmpty(QTCREATOR_SOURCES):QTCREATOR_SOURCES=/home/thomas/Projekte/qt-creator-opensource-src-3.1.1

## set the QTC_BUILD environment variable to override the setting here
IDE_BUILD_TREE = $$(QTC_BUILD)
isEmpty(IDE_BUILD_TREE):IDE_BUILD_TREE=/home/thomas/bin/Qt/Qt5.3.0/Tools/QtCreator
